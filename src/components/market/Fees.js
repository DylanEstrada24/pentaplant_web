...
class Fees extends Component {
  ...
  changeToTrading = () => {
    ...
    document.querySelector("#trading_button").style.borderBottom =
      "2px solid black";
  };
  ...
  changeToDeposit = () => {
    ...
    document.querySelector("#deposit_button").style.borderBottom =
      "2px solid black";
  };
        ...
        <div className="fees_wrapper">
          <div className="fees_container">
            <div className="fees_category">
              <a
                id="trading_button"
                onClick={this.changeToTrading}
                style={{ borderBottom: "2px solid black" }}
              >
                거래 수수료
              </a>
              <a id="deposit_button" onClick={this.changeToDeposit}>
                예금 및 인출 수수료
              </a>
            </div>
